				...
				<div class="col-sm-9">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<p>
								Título Original : ${ movie.title } <br> Actores : <br>
								Director: <br> Clasificación: ${ movie.classification } <br>
								Duración: ${ movie.duration } minutos <br> Género: ${ movie.genre }
								<br> Fecha Estreno: ${ movie.premiere }
							</p>
